...
add) is in
**[`docs/install.md`](https://github.com/bencalvin/FactoryAspects/blob/main/docs/install.md)**.
...
switcher, and a hand-drawn SVG icon set — see
**[`docs/index.md`](https://github.com/bencalvin/FactoryAspects/blob/main/docs/index.md)**
for the full inventory with usage examples for each, or download
[`docs/site.html`](https://github.com/bencalvin/FactoryAspects/blob/main/docs/site.html)
and open it in a browser for the same content as one scrollable page (no server
needed).
