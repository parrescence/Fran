namespace FactoryAspects.Internal;
...
/// </summary>
/// <remarks>
/// Named <c>ClassNames</c> rather than <c>CssClass</c> deliberately — most components
/// already expose a <c>CssClass</c> parameter, and a same-named type would be shadowed
/// by that parameter inside the component's own methods.
/// </remarks>
internal static class ClassNames
{
    ...
    /// (<c>ClassNames.Combine("fa-btn", Small ? "fa-btn-sm" : null, CssClass)</c>)
