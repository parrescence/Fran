...
/// mouse-wheel/trackpad scroll as a spin gesture, the same +1/-1 step as the arrow
/// keys — see <see cref="HandleFieldWheel"/>/<see cref="HandleDisplayYearWheel"/>.
/// </summary>
public sealed class FaDatePicker : InputBase<DateOnly?>
{
    ...
    private void RenderField(RenderTreeBuilder builder, int sequence, DateField field, string id, string placeholder, int maxLength, string value, Action<ElementReference> captureRef)
    {
        ...
        builder.AddAttribute(sequence + 10, "onwheel", EventCallback.Factory.Create<WheelEventArgs>(this, e => HandleFieldWheel(field, e)));
        builder.AddEventPreventDefaultAttribute(sequence + 11, "onwheel", true);
        builder.AddElementReferenceCapture(sequence + 12, captureRef);
        builder.CloseElement();
    }
    ...
    private void RenderCalendar(RenderTreeBuilder builder, int sequence)
    {
        ...
        builder.AddAttribute(sequence + 18, "onwheel", EventCallback.Factory.Create<WheelEventArgs>(this, HandleDisplayYearWheel));
        builder.AddEventPreventDefaultAttribute(sequence + 19, "onwheel", true);
        builder.CloseElement();
        ...
        for (var day = 1; day <= daysInMonth; day++)
        {
            ...
            builder.AddAttribute(seq++, "class", CssClassNames.Combine("fa-datepicker-day", isSelected ? "fa-datepicker-day-selected" : null, isToday && !isSelected ? "fa-datepicker-day-today" : null));
        ...
        builder.OpenElement(seq++, "button");
        builder.AddAttribute(seq++, "type", "button");
        builder.AddAttribute(seq++, "class", "fa-btn fa-btn-outline fa-btn-sm fa-datepicker-calendar-footer-btn");
